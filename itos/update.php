...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <input type="text" name="rut" placeholder="11.111.111-1" class="form-control" autofocus required value="<?php echo $fila['rut'] ?>">
    </div>
  </div>
</div>
