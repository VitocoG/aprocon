                ...
                <form action="" method="post" autocomplete="off">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="contacto" class="form-control"  autofocus>
                        </div>
                        <div class="col-md-3">
                            <label>Rut Contacto</label>
                            <input type="text" name="rutContacto" class="form-control" >
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <button type="submit" name="p" value="bancario" class="btn btn-success">
