...
foreach( $informe as $row )
{
	...
	$jefe_contrato  =   ( $localidad=="LINARES" || $localidad=="PARRAL" || $localidad=="CAUQUENES"|| $localidad=="CONSTITUCION"  )
							?	"RONALD ALEXIS VERGARA ARCOS"
							:	(	(	$localidad=="CURICO" )
										?	"MARTA ALMONACID LLANCAMIL"
										:	"ALVARO GUILLERMO GALDAMES CORREA"
								);
}
...
$dompdf->render( );
$dompdf->stream( "Ficha de ".$nombres." ".$apellidos.".pdf" );
