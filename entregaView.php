...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#recibida" aria-controls="recibida" role="tab" data-toggle="tab">Recibidas</a></li>
        </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-warning">
                            ...
                            <div class="panel-body">
<?php
$mostrarEntregas    = $model->SelectByKey( $class.'_enc', 'entrega', $_SESSION['id'], '' );
...
?>
            ...
            <div role="tabpanel" class="tab-pane fade" id="recibida">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-warning">
                            <div class="panel-heading"><h4>Recibidos</h4></div>
                            <div class="panel-body">
<?php
$mostrarRecibidos   =   $model->SelectByKey( $class.'_enc', 'recibe', $_SESSION['id'], '');   
if( $mostrarRecibidos->num_rows > 0 ):
    echo '                             
                                <div class="table-responsive">
...
foreach ($mostrarRecibidos as $keys ):
    $listarRecibo   =   $clase->ListarRecibo( $keys['id'] );
    foreach ($listarRecibo as $value ):
