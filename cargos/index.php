 <?php 
    ...
    $core   =   new core;
    session_start();
    $usuarios  = $core->Permisos( 'cargos', 'permisos', $_SESSION['id'] );
...
<div class="row">
  <div class="col-lg-8">
    <h3>Listado de Cargos <a href="create.php" ><button class="btn btn-success">Nuevo</button></a></h3>
  </div>
</div>
...
while($fila=$query->fetch_assoc()) { ?>
          <tr>
            ...
            <td>
              ...
              <a href="cargos.php?p=eliminar&id=<?php echo $fila['id'] ?>"><button class="btn btn-danger">Eliminar</button></a>
            </td> 
          </tr>
<?php } ?>
        </tbody>
